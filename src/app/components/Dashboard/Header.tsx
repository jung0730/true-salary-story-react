...
const Header = async () => {
  ...
  return (
    ...
    <div className="w-full h-full bg-white sm:rounded-b-[60px] lg:rounded-b-[200px]">
      <div
        className="container h-full mx-auto sm:max-w-[350px] md:max-w-[600px] lg:max-w-7xl flex flex-col lg:flex-row justify-center items-center"
      >
        <div className="w-full lg:w-1/2 md:w-1/1">
          <div
            className="flex flex-col justify-center sm:items-center lg:items-start sm:mt-16 md:mt-32 lg:mt-64 lg:mb-[277px]"
          >
