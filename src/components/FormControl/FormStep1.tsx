...
const FormStep1 = () => {
  ...
  const onSubmit = (data: SubmitPostForStep1) => {
    const convertData = {
      ...
      otherBonus: (data.otherBonus && Number(data.otherBonus)) || '',
      profitSharingBonus: (data.profitSharingBonus && Number(data.profitSharingBonus)) || '',
      yearEndBonus: (data.yearEndBonus && Number(data.yearEndBonus)) || '',
      avgHoursPerDay: (data.avgHoursPerDay && Number(data.avgHoursPerDay)) || '',
      holidayBonus: (data.holidayBonus && Number(data.holidayBonus)) || '',
      avgWorkingDaysPerMonth: (data.avgWorkingDaysPerMonth && Number(data.avgWorkingDaysPerMonth)) || '',
      dailySalary: (data.dailySalary && Number(data.dailySalary)) || '',
      monthlySalary: (data.monthlySalary && Number(data.monthlySalary)) || '',
      hourlySalary: (data.hourlySalary && Number(data.hourlySalary)) || '',
